...
import Key from './Key5';
import Spacebar from './Spacebar5';
    ...
    const seeRedLetters = () => {
      ...
      keys1.forEach((key, index) => {
        ...
        if (index === 0) {
          ...
          if (Math.abs(numberCode - prevLetterCode) === 1 || Math.abs(numberCode - downLeftLetterCode) === 1) {
            updatedKeys1Red[index] = 1;
          }
      ...
      keys2.forEach((key, index) => {
        ...
        if (index === 0) {
          ...
          if (Math.abs(numberCode - prevLetterCode) === 1 || Math.abs(numberCode - upLeftLetterCode) === 1
          || Math.abs(numberCode - upRightLetterCode) === 1) {
            updatedKeys2Red[index] = 1;
          }
