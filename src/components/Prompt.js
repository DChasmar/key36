...
function Prompt() {
    ...
    const iconColors = [
        ['#aaa', '#d99916', '#d22c35', '#89d5ff', '#d22c35', '#63b9ab', '#67ae4d', '#d99916', '#aaa', '#aaa'],
        ['#89d5ff', '#67ae4d', '#d99916', '#d22c35', '#aaa', '#e07ba1', '#23a7fa', '#aaa', '#63b9ab', '#d99916'],
        ['#63b9ab', '#23a7fa', '#aaa', '#67ae4d', '#efc18d', '#f7da21', '#23a7fa', '#e07ba1', '#67ae4d'],
